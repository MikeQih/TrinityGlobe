...
const translations = {
  en: {
    ...
    'checkout-payment-uncertain-btn': 'Confirming your payment…',
    'checkout-payment-uncertain-msg': "We're still confirming your payment with the bank — this can take a little longer than usual. Please don't submit again. If this doesn't resolve shortly, check your order status or reach us on WhatsApp.",
  ...
  zh: {
    ...
    'checkout-payment-uncertain-btn': '正在确认付款…',
    'checkout-payment-uncertain-msg': '我们仍在向银行确认您的付款，这可能比平时需要更长一点时间。请不要重复提交。如果长时间没有结果，请查看订单状态，或通过 WhatsApp 联系我们。',
