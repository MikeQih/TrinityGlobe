...
const translations = {
  en: {
    ...
    'nav-sign-in': 'Sign In', 'nav-my-orders': 'My Orders', 'nav-sign-out': 'Sign Out',
    ...
    'checkout-dob-hint': "We'll send you perks for your birthday!",
    ...
    'checkout-otp-lead': "Enter the 6-digit code we've sent to {email}",
  ...
  zh: {
    ...
    'checkout-title': '结账',
    'nav-sign-in': '登录', 'nav-my-orders': '我的订单', 'nav-sign-out': '退出登录',
    ...
    'checkout-dob': '出生日期',
    'checkout-dob-hint': '生日当天会为您发送专属福利！',
    ...
    'checkout-otp-lead': '验证码已发送至 {email}，请输入 6 位验证码',
