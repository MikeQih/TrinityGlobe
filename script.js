...
const translations = {
  en: {
    ...
    'nav-sign-in': 'Sign In', 'nav-my-orders': 'My Orders', 'nav-my-address': 'My Address', 'nav-sign-out': 'Sign Out', 'nav-account-menu': 'Account menu',
  ...
  zh: {
    ...
    'checkout-title': '结账',
    'nav-sign-in': '登录', 'nav-my-orders': '我的订单', 'nav-my-address': '我的地址', 'nav-sign-out': '退出登录', 'nav-account-menu': '账户菜单',
